...
VALUES (1, '2024-10-14', 'Started the week feeling anxious about the week.');

INSERT INTO journal_entries (user_id, entry_date, content)
VALUES (1, '2024-10-15', 'Had a productive day working on my app.');

INSERT INTO journal_entries (user_id, entry_date, content)
VALUES (1, '2024-10-16', 'Felt a bit stressed, but managed to handle it.');

INSERT INTO journal_entries (user_id, entry_date, content)
VALUES (1, '2024-10-17', 'i had a very hectic morning meeting, and my day was just all over the place.');

INSERT INTO journal_entries (user_id, entry_date, content)
VALUES (1, '2024-10-17', 'it was just a normal day');
